...
public class LimitAccess {
    public static String script = "local obj = KEYS[1]\n" +
            ...
            "end";
    public static boolean canVisit(Jedis jedis, String model, int limitNum, int
            limitTime){
        String r =
                jedis.eval(script,1,model,limitNum+"",limitTime+"").toString();
        return !"0".equals(r);
    }
}
